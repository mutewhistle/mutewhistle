...
import { Alert, ScrollView, StyleSheet, Text, TextBase, TextInput, View } from 'react-native'
...
import bip39words from '../../common/bip39words'
      ...
      >
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.pasteButton}>
            ...
            <Button testID="PaperKey"
              title={'Paper Key'}
              onPress={async () => { }}> PasteButton</Button>
          </View>
